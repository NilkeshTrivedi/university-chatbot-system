...
const Programs = (() => {
    ...
    function renderGrid(list) {
      ...
      <div class="program-card" onclick="Programs.openDetail('${p.id}')">
        ...
        <div class="pc-stats">
          <div class="pc-stat">
            <span class="pc-stat-val">${p.avg_gpa}</span>
            <span class="pc-stat-lab">Avg GPA</span>
          </div>
          <div class="pc-stat">
            <span class="pc-stat-val">${p.avg_sat}</span>
            <span class="pc-stat-lab">Avg SAT</span>
          </div>
          <div class="pc-stat">
            <span class="pc-stat-val">${p.avg_act}</span>
            <span class="pc-stat-lab">Avg ACT</span>
          </div>
        </div>
    ...
    async function openDetail(programId) {
      ...
      <i class="fa-solid fa-spinner fa-spin" style="font-size:2rem"></i>
        ...
        try {
            ...
            // Update dashboard compression meter
        ...
        <div class="drawer-compression">
          <div class="dc-title"><i class="fa-solid fa-bolt"></i> Scaledown Compression Stats</div>
          <div class="dc-stats">
            <div class="dc-stat">
              <div class="dc-val">${comp.original_tokens}</div>
              <div class="dc-lab">Original Tokens</div>
            </div>
            <div class="dc-stat">
              <div class="dc-val">${comp.compressed_tokens}</div>
              <div class="dc-lab">Compressed</div>
            </div>
            <div class="dc-stat">
              <div class="dc-val">${Math.round(comp.compression_ratio * 100)}%</div>
              <div class="dc-lab">Reduction</div>
            </div>
          </div>
        </div>
